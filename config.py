...
SRC_EMAIL = "zanjie1994@gmail.com"  #Your gmail account for sending mail to Kindle
DOMAIN = "http://zanjiekindle.appspot.com" #Your domain of apphttp://zanjiekindle.appspot.com/
